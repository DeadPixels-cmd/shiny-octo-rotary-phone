...
const App = () => {
    ...
    return (
        <div>
                ...
                <div className="about-content">
                    ...
                    <div className="stats">
                        <div className="stat-box">
                            ...
                            <div className="stat-label">VULNERABILITIES DISCLOSED</div>
                        </div>
                        <div className="stat-box">
                            <div className="stat-number">3</div>
                            <div className="stat-label">CVEs ASSIGNED</div>
                        </div>
                        <div className="stat-box">
                            <div className="stat-number">50+</div>
                            <div className="stat-label">PENTESTS COMPLETED</div>
                        </div>
                        <div className="stat-box">
                            <div className="stat-number">24/7</div>
                            <div className="stat-label">SECURITY MINDSET</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="exploits">
                <h2>exploits & research</h2>
                <div className="projects-grid">
                    <div className="project-card">
                        <div className="project-header">
                            <span className="vulnerability-badge">CRITICAL</span>
                    ...
                    <div className="project-card">
                        <div className="project-header">
                            <span className="vulnerability-badge">CRITICAL</span>
                            <div className="project-title">Zero-Day in IoT Device</div>
                        </div>
                        <div className="project-desc">
